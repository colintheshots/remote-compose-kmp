...
import androidx.compose.remote.player.compose.platform.isPlatformAnimationEnabled
import androidx.compose.remote.player.compose.platform.nanoTime
 ...
 *
 * It displays the document as well as providing the integration with the platform system (e.g.
...
internal fun RemoteComposePlayer(
    ...
    var start by remember(document) { mutableLongStateOf(nanoTime()) }
    ...
    val remoteContext by
        remember(document) {
            ...
            composeRemoteContext.a11yAnimationEnabled = isPlatformAnimationEnabled()
            composeRemoteContext.setDebug(debugMode)
            composeRemoteContext.setTheme(theme)
    ...
    Canvas(
                    ...
                    while (true) {
                        ...
                        for (i in 0 until event.changes.size) {
                            ...
                            if (change.changedToDown()) {
                                ...
                                val time = remoteContext.getAnimationTime()
        ...
        drawIntoCanvas {
            ...
            if (remoteContext.isAnimationEnabled()) {
                ...
                remoteContext.setAnimationTime(animationTime)
            ...
            remoteContext.setDensity(density)
