...
class DrawOval(left: Float, top: Float, right: Float, bottom: Float) :
    ...
    companion object {
        private val OP_CODE = Operations.DRAW_OVAL
        private const val CLASS_NAME = "DrawOval"

        fun name(): String = CLASS_NAME
        fun id(): Int = OP_CODE

        fun read(buffer: WireBuffer, operations: MutableList<Operation>) {
            read(buffer, operations, Maker(::DrawOval))
        }
