...
class MatrixTranslate(translateX: Float, translateY: Float) :
    DrawBase2(translateX, translateY) {
    ...
    companion object {
        private val OP_CODE = Operations.MATRIX_TRANSLATE
        private const val CLASS_NAME = "MatrixTranslate"

        fun name(): String = CLASS_NAME
        fun id(): Int = OP_CODE

        fun read(buffer: WireBuffer, operations: MutableList<Operation>) {
            read(buffer, operations, Maker(::MatrixTranslate))
        }
