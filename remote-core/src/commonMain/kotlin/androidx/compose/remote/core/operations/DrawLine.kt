...
/** Draw a line segment */
class DrawLine(left: Float, top: Float, right: Float, bottom: Float) :
    ...
    companion object {
        private val OP_CODE = Operations.DRAW_LINE
        private const val CLASS_NAME = "DrawLine"

        fun name(): String = CLASS_NAME
        fun id(): Int = OP_CODE

        fun read(buffer: WireBuffer, operations: MutableList<Operation>) {
            read(buffer, operations, Maker(::DrawLine))
        }
