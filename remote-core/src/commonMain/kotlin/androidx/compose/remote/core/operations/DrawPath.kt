...
/** Draw a path */
class DrawPath(private val mId: Int) : PaintOperation(), Serializable {

    private var mStart: Float = 0f
    private var mEnd: Float = 1f

    override fun write(buffer: WireBuffer) {
        apply(buffer, mId)
    }

    override fun toString(): String = "DrawPath [$mId], $mStart, $mEnd"
    ...
    companion object {
        private val OP_CODE = Operations.DRAW_PATH
        private const val CLASS_NAME = "DrawPath"
