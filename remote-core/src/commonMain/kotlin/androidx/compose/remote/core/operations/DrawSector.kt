...
class DrawSector(
    ...
    companion object {
        private val OP_CODE = Operations.DRAW_SECTOR
        private const val CLASS_NAME = "DrawSector"

        fun id(): Int = OP_CODE

        fun read(buffer: WireBuffer, operations: MutableList<Operation>) {
            read(buffer, operations, Maker(::DrawSector))
        }
