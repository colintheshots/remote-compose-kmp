...
/** Draw a circle */
class DrawCircle(centerX: Float, centerY: Float, radius: Float) :
    DrawBase3(centerX, centerY, radius) {
    ...
    companion object {
        private val OP_CODE = Operations.DRAW_CIRCLE
        private const val CLASS_NAME = "DrawCircle"

        fun name(): String = CLASS_NAME
        fun id(): Int = OP_CODE

        fun read(buffer: WireBuffer, operations: MutableList<Operation>) {
            read(buffer, operations, Maker(::DrawCircle))
        }
